...
import { imageSchema, profileSchema, propertySchema, validatedWithZodSchema } from "./schemas";
import db from './db';
...
const renderError = (error: unknown): { message: string} =>{
    console.log(error)
    return { message: error instanceof Error ? error.message : 'An error has occurred' }
}
...
export const createPropertyAction = async (
    ...
    try {
        ...
        const validateFile = validatedWithZodSchema(imageSchema, {image: file})
